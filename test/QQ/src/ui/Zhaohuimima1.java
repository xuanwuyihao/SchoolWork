...
public class Zhaohuimima1 extends JFrame{
...
////		unames.setEchoChar('●');
		...
		//验证码图片
		JLabel yzm2=new JLabel(new ImageIcon("image/yzm1.jpg"));
	...
	private void setDragable() {
		this.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseReleased(java.awt.event.MouseEvent e) {
				isDragged = false;
				Zhaohuimima1.this.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
			}
		...
		this.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
			public void mouseDragged(java.awt.event.MouseEvent e) {
				if (isDragged) {
					loc = new Point(Zhaohuimima1.this.getLocation().x + e.getX()
							- tmp.x, Zhaohuimima1.this.getLocation().y + e.getY()
							- tmp.y);
					Zhaohuimima1.this.setLocation(loc);
				}
			}
		});
	}
