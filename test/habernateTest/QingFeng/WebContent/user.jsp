	...
	$(function(){
		$("#cc").datagrid({
			...
			columns : [[   
					...
					{field : "u_id",   title : "编号", width : 70, sortable : true},
					{field : "u_name", title : "角色名称", width : 70, sortable : true},
					{field : "u_seq",  title : "排序号", width : 70, sortable : true},
					{field : "u_description",  title : "描述", width : 170, sortable : true},
					{field : "u_state",  title : "状态", width : 70, sortable : true},
...
<a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'"  onclick="alert('vfss')">新增</a>
	<input type="button" value="刷新" id="tj" style="cursor:pointer"/>
	
	<p>json:<s:property value="json"/></p>
	<s:textfield name="sjgjsjdjs" id="jssn" label="json:" />
</div>
