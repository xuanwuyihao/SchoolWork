...
<body >
    ...
    <input type="text" id="session" value="${Lift }" style="display: none;" >
        <div class="x-nav">
            ...
            <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"  href="logLift/logLift-list" title="刷新"><i class="layui-icon" style="line-height:30px">ဂ</i></a>
        </div>
        <div class="x-body">
            <form class="layui-form x-center" action="logLift/logLift-mh" id="from1" style="width:800px">
            ...
            <table class="layui-table">
                ...
                <c:forEach items="${list }" var="list">
                    <tr>
                        ...
                        <td >
	 						<fmt:formatDate value="${list.lefttime }" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </td>
                        <td>
                             ${list.lastmoney }
                        </td>
        ...
        <script type="text/javascript">
		        ...
		        function option(curr){
		        	...
		        	window.location.href='logLift/logLift-fy?id='+curr+'&'+'username='+title+'&'+'oyh1='+people;
        ...
        <script>
            layui.use(['laydate','element','laypage','layer'], function(){
      		...
      		if(session!=''){
      			window.location.href='logLift/logLift-list';
      		}	
