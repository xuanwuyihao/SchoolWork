...
<head>
<meta charset="utf-8">
<title>金字塔 - 综合金融服务后台管理 - 站内信 - 修改</title>
<base href="<%=path%>/">
		...
		<form class="layui-form" id="form1" name="form1">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="hidden" id="id" value="${letter.id}">
					<input type="text" value="${letter.sendpeople}" name="sendpeople"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="receivepeople" style="width: 300px"
						id="receivepeople" value="${letter.receivepeople}" lay-verify="required" autocomplete="off"
						class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
					<span class="x-red"></span>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="title" value="${letter.title}" style="width: 300px" id="title"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<textarea name="content" autocomplete="off" id="content"
						...
						<input type="hidden" id="content1" value="${letter.content}">
				</div>
			</div>
			<div class="layui-form-item">
