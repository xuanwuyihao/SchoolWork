...
<div class="row">
            <div class="col-xs-6 col-sm-4 col-md-3">
                <section class="panel">
                    ...
                    <div class="value tab-menu" bind="1">
                        ...
                        <a href="javascript:;" data-url="user-info.jsp" data-parent="true" data-title="机构总数"> <i class="iconfont " data-icon=""></i><span>机构总数</span></a>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3">
                <section class="panel">
                    ...
                    <div class="value tab-menu" bind="1">
                        ...
                        <a href="javascript:;" data-url="user-info.jsp" data-parent="true" data-title="今日新增"> <i class="iconfont " data-icon=""></i><span>今日新增</span></a>
            ...
            <div class="col-xs-6 col-sm-4 col-md-3">
                <section class="panel">
                    ...
                    <div class="value tab-menu" bind="1">
                        ...
                        <a href="javascript:;" data-url="user-info.jsp" data-parent="true" data-title="订单总数"> <i class="iconfont " data-icon=""></i><span>订单总数</span></a>
                    </div>
                </section>
            </div>
        ...
        <div class="col-sm-6">
         <section class="panel">
                    <div class="panel-heading">下半年统计</div>
                    <div class="panel-body">
