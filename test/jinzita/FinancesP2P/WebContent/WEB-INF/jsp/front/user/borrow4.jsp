				 	 ...
				 	 <li style="display: inline;float: left;">
					 	 <div style="height: 40px;border-bottom: 1px solid #e0e0e0;" align="left">
					 	 	...
					 	 	<font style="font-size: 20px;" color="red">
					 	 		￥<fmt:formatNumber value="${tsum+msum }" pattern="#,###.00" />
					 	 	</font>
					 	 </div>
				 	 <div>
				 	 	<ul>
				 			...
				 			<li style="display: inline;float: right;margin: 30px 20px;">
				 				<div style="height: 30px;">
				 					<ul>
				 					<li style="display: inline;float: left;margin-top: 5px;margin-left: 10px;">
				 					<div class="xfk2"></div>
				 					</li>
				 					<li style="display: inline;float: left;margin-left: 5px;">
				 					<font color="#c3c3c3">投标中借款:</font>
				 					<font color="gray" style="margin-left: 0px;">￥0.00</font>
				 					</li>
				 					</ul>
				 				</div>
				 				<div>
				 					...
				 					<font color="gray" style="margin-left: 0px;">￥${msum }</font>
				 					</li>
				 					</ul>
				 				</div>
				 			</li>
				 	...
				 	<li style="display: inline;float: right;">
				 		<div>
				 		 <div style="height: 40px;border-bottom: 1px solid #e0e0e0;" align="left">
					 	 	<font>累计利息:</font>
					 	 	<font style="font-size: 20px;" color="red">
					 	 		￥<fmt:formatNumber value="${sum[0].stillmoney-tsum-msum }" pattern="#,###.00" />
					 	 	</font>
					 	 </div>
				 	 	<ul>
				 	 		<li style="display: inline;float: left;">
				 			...
				 			<li style="display: inline;float: right;margin: 30px 20px;">
				 				<div style="margin-left: 30px;height: 30px;">
				 					<ul>
				 					<li style="display: inline;float: left;margin-top: 5px;margin-left: -20px;">
				 					<div class="xfk4"></div>
				 					</li>
				 					<li style="display: inline;float: left;margin-left: -5px;">
				 					<font color="#c3c3c3">待付利息:</font>
				 					<font color="gray" style="margin-left: 0px;">￥${sum[0].stayinterest }</font>
				 					</li>
				 					</ul>
				 				</div>
				 				<div style="height: 30px;">
				 					...
				 					<font color="gray" style="margin-left: 0px;">￥${sum[0].stillmoney-tsum-msum-sum[0].stayinterest }</font>
				 					</li>
				 					</ul>
				 				</div>
				 			</li>
							...
							<div id="myTabContents" class="tab-content">
								<div style="margin-top: 20px;">
									<table style="width: 100%" border="0">
										...
										<c:forEach items="${userlist2}" var="list">
											<!-- 2 -->
											<tr class="t2">
											...
											<td style="color: gray;font-size: 13px;">
											${list.lendmoney-list.have_cast }元
											</td>
											<td style="color: gray;font-size: 13px;">
											${list.rate }%	
											</td>
				...
				<ul>
					...
					<div class="ze">
						...
						<div align="left" style="margin-top: 5px;color: gray">
							<font style="font-size: 20px;color: red">
							￥<fmt:formatNumber value="${sum[0].staygold }" pattern="###,###.00"/>
							</font>
							
						</div>
						<div align="left" style="margin-top: 5px;color: gray">
							本金￥${sum[0].staygold-sum[0].stayinterest } + 利息￥${sum[0].stayinterest }</div>
					</div>
					</li>
					<li style="display: inline;float: left;margin: 35px 20px;">
						...
						<div style="margin-top: 10px;"align="left">
							<fmt:formatDate value="${sum[0].realstilltime }" pattern="yyyy-MM-dd HH:mm:ss"/>
						</div>
					</li>
				</ul>
				</div>
					...
					<div>
						<table>
							...
							<c:forEach items="${userlist3}" var="list">
								...
								<td style="color: gray;font-size: 13px;">
								<fmt:formatDate value="${list.realstilltime }" pattern="yyyy-MM-dd HH:mm:ss" />
								</td>
								<td style="color: gray;font-size: 13px;">
								${list.hasmoney }
								</td>
...
<script type="text/javascript">
	...
	/* 第二个饼图 */
	 ...
	 var f5 = ${sum[0].stayinterest };
	 var f6 = ${sum[0].stillmoney }-0.00-${msum }-${sum[0].stayinterest }; 
	 option = {
