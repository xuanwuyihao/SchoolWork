		...
		columns:[[   
					...
					},
		           {
		                ...
		                formatter : function(value, row, index) {
		                    var str = '';
		                            str += '<a href="javascript:void(0)" class="notice-easyui-linkbutton-edit" data-options="plain:true,iconCls:\'icon-wjxg\'" onclick="editNoticeFun('+index+');" >编辑</a>';
		                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';
		                            str += '<a href="javascript:void(0)" class="notice-easyui-linkbutton-del" data-options="plain:true,iconCls:\'icon-scnr\'" onclick="deleteNoticeFun('+index+');" >删除</a>';
		                    return str;
		                }
		            }
...
function filechan(val){
	...
	$("#cf_state").val(2);
	document.getElementById('tp').value=val.value
	alert("====");
}
</script>
...
<body class="easyui-layout">
	...
	<div class="easyui-layout" data-options="fit:true,border:false">
	 ...
	 <div id="dd" icon="icon-save" style="width: 80%; height: 400px; max-width: 800px; padding: 2px; display: none;">  
	<form name="edit" action="rmup" method="post" enctype="multipart/form-data">
  <p>标题：<input type="text" id="tit" class="ct" name="hot_major.hm_title"/></p>  
  <p>图片：<!-- <input type="text" id="tp" name="hot_major.hm_picture"/> -->
  	<div class="report-file">
		...
		<input type="hidden" name="cf_src2" id="cf_src2"/>  <!-- 未上传文件是保存原来的图片路径 -->
			...
			<input type="hidden" name="hm_state" id="hm_state" value="1"/>
			<input type="hidden" name="hm_src2" id="hm_src2"/>  <!-- 未上传文件是保存原来的图片路径 -->
			
	<input type="text" id="tp" name="hot_major.hm_picture" style="height: 28px;border:1px solid #f1f1f1" />
  </p>  
  <p>内容：<!-- <input type="text" id="nr" name="hot_major.hm_content"/> -->
  	<textarea rows="10" cols="20" id="nr" class="cz" id="nr" name="hot_major.hm_content" ></textarea>
  </p> 
   ...
   <p><input type="hidden" id="id" name="hot_major.hm_id"/></p>
	...
	<div id="dlg" class="easyui-dialog" title="修改"
		...
		data-options="
			...
			">
			<form name="add" action="rmadd" method="post" enctype="multipart/form-data">
		<p>
			<label class="la">标题：</label><input type="text" id="t" class="ct" name="hot_major.hm_title" />
			<br /><br />
			<!-- <label class="la">图片：</label> -->
			<!-- <span style="display:inline-block;width:20px; height:50px;"></span> -->
			<div class="report-file">
			      <span>专业图片</span>
			...
			<textarea rows="10" cols="20" id="nr" class="cz" name="hot_major.hm_content" ></textarea>
		</p>
		</form>
	</div>	 
