...
window.Modernizr = function (e, t, n) {
  ...
  function H() {
    ...
    i.inputtypes = function (e) {
      for (var r = 0, i, s, u, a = e.length; r < a; r++) l.setAttribute('type', s = e[r]),
      i = l.type !== 'text',
  ...
  N = function () {
    function r(r, i) {
      ...
      r = 'on' + r;
      var s = r in i;
      return s || (i.setAttribute || (i = t.createElement('div')), i.setAttribute && i.removeAttribute && (i.setAttribute(r, ''), s = O(i[r], 'function'), O(i[r], 'undefined') || (i[r] = n), i.removeAttribute(r))),
      i = null,
      s
    }
    var e = {
  ...
  y.rgba = function () {
    ...
    M(f.backgroundColor, 'rgba')
  },
  y.hsla = function () {
    return L('background-color:hsla(120,40%,100%,.5)'),
    M(f.backgroundColor, 'rgba') || M(f.backgroundColor, 'hsla')
  },
  ...
  y.cssgradients = function () {
    ...
    return L((e + '-webkit- '.split(' ').join(t + e) + p.join(n + e)).slice(0, - e.length)),
    M(f.backgroundImage, 'gradient')
  },
