...
<div id="dlg" class="easyui-dialog" title="修改"
	...
	<table class="table">
		<tr class="tr">
			...
			<th class="th" id="Gxw">学习内容</th>
			<th class="th" id="Xtt">报名日期</th>
		...
		<tr class="tr">
			...
			<td class="td" id="ck4">13569953343</td>
			<td class="td" id="ck5">艺考</td>
			<td class="td" id="ck6">美术设计与鉴赏</td>
			<td class="td" id="ck7">2017-08-23 19:22:32</td>
