...
<body>
	...
	<div id="demo3" class="jcImgScroll">
		<ul>
			<li><a href="#" path="images/ncb/01.jpg"></a></li>
			<li><a href="#" path="images/ncb/02.jpg"></a></li>
			<li><a href="#" path="images/ncb/03.jpg"></a></li>
			<li><a href="#" path="images/ncb/04.jpg"></a></li>
			<li><a href="#" path="images/ncb/05.jpg"></a></li>
			<li><a href="#" path="images/ncb/06.jpg"></a></li>
			<li><a href="#" path="images/ncb/07.jpg"></a></li>
			<li><a href="#" path="images/ncb/08.jpg"></a></li>
			<li><a href="#" path="images/ncb/09.jpg"></a></li>
