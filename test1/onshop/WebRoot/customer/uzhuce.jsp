			...
			<div class="zhuce_kong">
				<div class="zc">
					<div class="bj_bai">
						...
						<form action="<%=basePath %>users?method=uzhuce" method="post"
							name="form1">
							
							</c:if>
							
							<input name="uaccount" type="text" class="kuang_txt phone"
								placeholder="手机号">
							<input name="upwd" type="password" class="kuang_txt possword"
								placeholder="密码">
							<input name="bpwd1" type="password" class="kuang_txt possword"
								placeholder="确认密码">
								<input name="umail" type="text" class="kuang_txt phone"
								placeholder="E-mail">
					...
					<div class="bj_right">
						...
						<p>
							已有账号？
							<a href="customer/userlogin.jsp">立即登录</a>
						</p>
